...
# Based on the original packaging by Pedro Gabriel <pedrogabriel@dcc.ufmg.br> and FadeMind <fademind@gmail.com>
...
# Maintainer: Ross Clark <https://github.com/Archiv8/aic94xx-firmware/discussions>
# Contributor: Ross Clark <https://github.com/Archiv8/aic94xx-firmware/discussions>
...
arch=("any")
source=(
  "${_fwname}-seq-${pkgver}-1.tar.gz::http://download.adaptec.com/scsi/linux/${_fwname}-seq-${pkgver}-1.tar.gz"
  "LICENSE.${_fwname}")
sha256sums=(
